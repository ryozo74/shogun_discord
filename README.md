...
multi-agent-shogun supports two-way Discord communication (cmd_417/429/438).
...
1. Copy `.env.example` to `.env` and fill in your Discord credentials:
   ...
   ```
2. Start the listener: `bash scripts/discord_listener.sh &`
3. Send messages: `bash scripts/discord.sh "message"`
4. View conversation history: `bash scripts/discord_conversation.sh`
